...
- Assumptions: Slice 1B software and physical acceptance are complete. Direct IP remains available throughout. Continue with Slice 3 codec/fixture generalization.
