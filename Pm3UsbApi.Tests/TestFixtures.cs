...
public static class TestFixtures
{
    ...
    // --- lf t55 dump Iceman format with [+] prefix ---
    public const string DumpSuccessIceman = """
        [+] blk | hex data | binary                           | ascii
        [+] ----+----------+----------------------------------+-------
        [+]  00 | 00148040 | 00000000000101001000000001000000 | ...@
        [+]  01 | 9BFE0062 | 10011011111111100000000001100010 | ...b
        [+]  02 | 5BA4A3DE | 01011011101001001010001111011110 | [...
        [+]  03 | D5D1D713 | 11010101110100011101011100010011 | ....
        [+]  04 | D5D1D713 | 11010101110100011101011100010011 | ....
        [+]  05 | CCC61159 | 11001100110001100001000101011001 | ...Y
        [+]  06 | CCC61159 | 11001100110001100001000101011001 | ...Y
